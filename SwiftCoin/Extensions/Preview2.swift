...
//  SwiftCoin
//
//  Created by Ankit Kaushik on 04/01/24.
//
import Foundation
import SwiftUI
...
extension PreviewProvider {
    ...
    static var dev1: DeveloperPreview1 {
        return DeveloperPreview1.instance
    }
    
}

class DeveloperPreview1 {
    
    static let instance = DeveloperPreview1()
    private init() { }
    
     let homeVM2 = HomeModel()
